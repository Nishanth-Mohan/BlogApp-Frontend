    ...
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
        ...
        <form className='flex flex-col gap-5' onSubmit={handleSubmit}>
            <div className='flex flex-col gap-4 sm:flex-row justify-between'>
              <TextInput type='text' placeholder='Enter the Title' required id='title' className='flex-1' onChange={(e)=>setFormData({...formData,title:e.target.value})}/>
            ...
            <div className='flex gap-4 items-center justify-between border-4 border-teal-500 border-dotted p-3'>
                ...
                <Button type='button' gradientDuoTone="greenToBlue" size='sm' onClick={handleUploadImage} disabled={imageFileUploadProgress}>
           ...
           {publishError && (<Alert color="failure" className='mt-4' icon={HiInformationCircle}>
            <span className="font-medium">OOPS!📝</span>&nbsp;{publishError}.
            </Alert>)}
